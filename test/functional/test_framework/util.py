...
# This fork renamed the configuration file; see BITCOIN_CONF_FILENAME in
# src/common/args.cpp. Writing "bitcoin.conf" here leaves every node without a
# config file at all, which silently starts it on mainnet instead of regtest.
CONF_FILENAME = "ecash.conf"
